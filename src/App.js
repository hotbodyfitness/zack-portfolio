        ...
        <header className='App-header'>
          <div id='textGrid'>
            <div id='mainFlex'>
              ...
              <div className='container'>
                <a className='logos' href='https://github.com/hotbodyfitness/' target='_blank' rel='noopener noreferrer'><img src='https://img.icons8.com/color/40/000000/github--v1.png' alt=''></img></a>
                <a className='logos' href='https://www.linkedin.com/in/zkmiller/' target='_blank' rel='noopener noreferrer'><img src='https://img.icons8.com/color/40/000000/linkedin-circled.png' alt=''></img></a>
              </div>
            </div>
          ...
          <div id='projectTop'>
            <div className='bigApp'>
              <a href='http://thebdayapp.com/' target='_blank' rel='noopener noreferrer'>
              ...
              <div className='bigAppText'>
                ...
                <a href='http://thebdayapp.com/' target='_blank' rel='noopener noreferrer' className='bigLinkApp'>Live App</a>
              </div>
            </div>
          ...
          <div id='projectGrid'>
            <div className='appContainer'>
              <a href='https://minesweeper-zack.herokuapp.com/' target='_blank' rel='noopener noreferrer'>
              ...
              <div className='miniAppTextContainer'>
                ...
                <a href='https://minesweeper-zack.herokuapp.com/' target='_blank' rel='noopener noreferrer' className='linkApp'>Live App</a>
              </div>
            </div>
            <div className='appContainer'>
              <a href='https://cryptocurrency-charting.herokuapp.com/' target='_blank' rel='noopener noreferrer'>
              ...
              <div className='miniAppTextContainer'>
                ...
                <a href='https://cryptocurrency-charting.herokuapp.com/' target='_blank' rel='noopener noreferrer' className='linkApp'>Live App</a>
              </div>
            </div>
            <div className='appContainer'>
              <a href='https://bowling-zack.herokuapp.com/' target='_blank' rel='noopener noreferrer'>
              ...
              <div className='miniAppTextContainer'>
                ...
                <a href='https://bowling-zack.herokuapp.com/' target='_blank' rel='noopener noreferrer' className='linkApp'>Live App</a>
              </div>
            </div>
            <div className='appContainer'>
              <a href='https://connect-four-zack.herokuapp.com/' target='_blank' rel='noopener noreferrer'>
              ...
              <div className='miniAppTextContainer'>
                ...
                <a href='https://connect-four-zack.herokuapp.com/' target='_blank' rel='noopener noreferrer' className='linkApp'>Live App</a>
              </div>
            </div>
            <div className='appContainer'>
              <a href='https://soundcloud-bottom-player.herokuapp.com/' target='_blank' rel='noopener noreferrer'>
              ...
              <div className='miniAppTextContainer'>
                ...
                <a href='https://soundcloud-bottom-player.herokuapp.com/' target='_blank' rel='noopener noreferrer' className='linkApp'>Live App</a>
              </div>
            </div>
            <div className='appContainer'>
